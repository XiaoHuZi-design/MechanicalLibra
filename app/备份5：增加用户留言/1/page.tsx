...
const MechanicalLibra = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 to-purple-200 flex p-4">
      {/* 左侧侧边栏 */}
      <aside className="w-64 bg-white rounded-3xl shadow-xl p-4 space-y-6 fixed top-4 left-4 md:w-80">
      ...
      {/* 主要内容区域 */}
      <main className="ml-80 flex-1 flex items-center justify-center p-4 md:p-8 lg:p-12">
        <motion.div 
        ...
        >
          ...
          <motion.section
            ...
            className="bg-white rounded-3xl shadow-xl p-4 space-y-4 mt-4"
          >
          ...
          <motion.section
            ...
            className="bg-white rounded-3xl shadow-xl p-4 space-y-4 mt-4"
          >
            <h2 className="text-xl font-bold text-center text-gray-800">最新动态</h2>
            <ul className="list-disc list-inside text-gray-700">
              <li><Link href="/post1" className="text-blue-500 hover:text-blue-700">2024-11-01 发布了新文章《如何学习编程》</Link></li>
              <li><Link href="/post2" className="text-blue-500 hover:text-blue-700">2024-10-25 参加了编程马拉松比赛</Link></li>
              <li><Link href="/post3" className="text-blue-500 hover:text-blue-700">2024-10-15 开始学习React框架</Link></li>
            </ul>
          </motion.section>
        </motion.div>
